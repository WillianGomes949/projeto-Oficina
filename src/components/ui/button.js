...
export default function Button ({ children, onClick, color = 'blue', className = '' }) {
  const colorSchemes = {
    ...
    blue: 'bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300',
  ...
  const baseClasses = 
    'px-4 py-2 text-sm font-medium text-white text-center rounded-lg transition-colors duration-150';
